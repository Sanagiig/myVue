...
import {VNodeData,VNode as _VNode} from '../../interface/vnode'
...
export class FunctionalRenderContext  {
  ...
  data: VNodeData,
  props: any,
  children: Array<_VNode> | undefined,
  parent: Component,
  Ctor: ComponentCtor
  ) {
    ...
    this.slots = () => resolveSlots(<_VNode[]>children, parent)
