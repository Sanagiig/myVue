...
function sameVnode (a:_VNode, b:_VNode) {
  return (
    a.key === b.key && (
      (
        a.tag === b.tag &&
...
export function createPatchFunction (backend:any) {
  ...
  function createRmCb (childElm:any, listeners:any) {
    function remove () {
  ...
  function isUnknownElement (vnode:_VNode, inVPre:any) {
    return (
      !inVPre &&
      !vnode.ns &&
      !(
  ...
  function createComponent (vnode:_VNode, insertedVnodeQueue:any, parentElm:any, refElm:any) {
  ...
  function reactivateComponent (vnode:_VNode, insertedVnodeQueue:any, parentElm:any, refElm:any) {
    let i
  ...
  function createChildren (vnode:_VNode, children:any, insertedVnodeQueue:any) {
  ...
  function removeVnodes (parentElm:any, vnodes:any, startIdx:any, endIdx:any) {
    for (; startIdx <= endIdx; ++startIdx) {
  ...
  function invokeInsertHook (vnode:any, queue:any, initial:any) {
