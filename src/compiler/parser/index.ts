...
export function parse (
  ...
  transforms = pluckModuleFunction(<any[]>options.modules, 'transformNode')
  preTransforms = pluckModuleFunction(<any[]>options.modules, 'preTransformNode')
  postTransforms = pluckModuleFunction(<any[]>options.modules, 'postTransformNode')
